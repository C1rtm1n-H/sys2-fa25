...
module CSRModule(
    ...
    // 修改：正确设置 mstatus 的 SXL(35:34) 和 UXL(33:32) 为 2'b10 (64-bit)
    // 结构: [63:36]Reserved(28) | [35:34]SXL(2) | [33:32]UXL(2) | [31:13]Reserved(19) | ...
    wire [63:0] mstatus={28'b0, 2'b10, 2'b10, 19'b0, mpp_reg,hpp_reg,spp_reg,mpie_reg,hpie_reg,spie_reg,upie_reg,
                mie_reg,hie_reg,sie_reg,uie_reg};

    // 修改：正确设置 sstatus 的 UXL(33:32) 为 2'b10 (64-bit)
    // 结构: [63:34]Reserved(30) | [33:32]UXL(2) | [31:9]Reserved(23) | ...
